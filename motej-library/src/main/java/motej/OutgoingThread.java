...
class OutgoingThread extends Thread {
	...
	private static final Logger log = LoggerFactory.getLogger(OutgoingThread.class);
	...
	protected OutgoingThread(Mote source, String btaddress) throws IOException, InterruptedException {
		...
		String l2cap = "btl2cap://" + btaddress + ":11;authenticate=false;encrypt=false;master=false";
